...
export default {
  ...
  methods: {
    ...
    async toggleComplete(todo) {
      try {
        // Toggle the completed status and update in the database
...
.completed {
  text-decoration: line-through; /* Line-through for completed todos */
  color: #6c757d; /* Optional: lighter color for completed todos */
}
